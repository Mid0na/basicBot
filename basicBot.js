...
(function () {
    ...
    var basicBot = {
        ...
        settings: {
            ...
            intervalMessages: ["LGD_Bot commandes : !commands",
            	"Pour AutoWoot, nous recommandons PluggedN (http://goo.gl/TGJePX), ou PlugCubed (http://goo.gl/QdXQR4)",
            	"Suivez-nous sur FaceBook : !fb",
            	"Donnez un cookie aux utilisateurs de la salle : !cookie @user",
            	"Visitez notre site web : !website",
           	"Temps restant avant de passer DJ : !eta",
            	"Abonnez-vous à notre chaîne Youtube : !youtube"],
            messageInterval: 5,
            songstats: false,
            commandLiteral: "!",
            blacklists: {
